"""
Django settings for little_unit_40605 project.
...
ROOT_URLCONF = 'little_unit_40605.urls'
...
WSGI_APPLICATION = 'little_unit_40605.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_unit_40605 API",
    "DESCRIPTION": "API documentation for little_unit_40605 App",
    "VERSION": "v1",
}
